...
$script:LabelMappings = @{
    ...
    "DiscordGameEndActionLabel" = "gameEndActionLabel"
    "DiscordProcessNameLabel" = "processNameLabel"
    "DiscordArgumentsLabel" = "argumentsLabel"
    "DiscordTerminationMethodLabel" = "terminationMethodLabel"
    "DiscordGracefulTimeoutLabel" = "gracefulTimeoutLabel"
